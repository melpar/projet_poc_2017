        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-half">
                <div class="w3-card white">
                    ...
                    <ul class="w3-ul w3-border-top">
                        <li>
                            <p>1- <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a></p>
                        </li>
                    </ul>
                    <div class="w3-container w3-theme w3-large"><span class="w3-right"><button class="w3-btn" style="font-weight:900;">Modifier</button></span></div>
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="w3-card white">
                <div class="w3-padding w3-white w3-display-container">
                  <div class="w3-container w3-orange">
                    ...
                    <div class="w3-container w3-orange w3-large"><span class="w3-right"><button class="w3-btn" style="font-weight:900;">Modifier</button></span></div>
           		</div>
            </div>
        </div>
